...
router.put('/:id', protect, authorize('owner', 'admin'), upload.single('document'), updateMinnagam);
router.patch('/:id/status', protect, authorize('owner', 'admin'), updateMinnagamStatus);

...
/* CREATE */
router.post("/",protect ,authorize("admin"), uploadGallery.array("images", 10), createGallery);

/* UPDATE */
router.put("/:id",protect, authorize("admin"), uploadGallery.array("images", 10), updateGallery);
